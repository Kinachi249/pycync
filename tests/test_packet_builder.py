...
def test_build_login_packet(mocker):
    mocker.patch("pycync.management.packet_builder._get_and_increment_packet_counter", return_value=1)
...
def test_build_power_state_request_packet(mocker):
    mocker.patch("pycync.management.packet_builder._get_and_increment_packet_counter", return_value=1)
    mocker.patch("pycync.management.pipe_packet_builder._get_and_increment_sequence_bytes", return_value=int(257).to_bytes(4, "little"))
